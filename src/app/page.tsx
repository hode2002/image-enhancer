                ...
                <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl">
                    <span className="flex gap-2">
                        <RotatingText
                            ...
                            mainClassName="w-fit px-2 sm:px-2 md:px-3 bg-gradient-to-l from-blue-500 to-purple-600 bg-cyan-300 text-black overflow-hidden py-0.5 sm:py-1 md:py-2 justify-center rounded-lg"
                            staggerFrom={'last'}
                            initial={{ y: '100%' }}
                            animate={{ y: 0 }}
                            exit={{ y: '-120%' }}
